		...
		change: function(e){
			...
			$("#ws-ui-113762-1").kendoGrid({
				dataSource: {
					...
					transport: {
						read: {
							url: "https://script.google.com/macros/s/AKfycbzcFm28XV2ikvDsBV0cmAp57MQt1y0hKnfXJAiUqugqWDx9exk/exec?type=month&rl="+window.authUser[0].Role+"&usersl="+window.currentUserItem3+"&month="+udate
						}
					},
