...
_uiGrid(
	'ws-ui-112345', 
	"https://script.google.com/macros/s/AKfycbwd7cfIIFfE29oIaPv905p5WwTclpNjURJlucEiiULfz97Znxg/exec?type=grid&rl="+window.authUser[0].Role, 
	"https://script.google.com/macros/s/AKfycbwd7cfIIFfE29oIaPv905p5WwTclpNjURJlucEiiULfz97Znxg/exec", 
	550, 20, {
		ID: {type: "string"}, 
		Name: {type: "string"}, 
		Email: {type: "string"},
...
$("#ws-ui-112345 .k-grid-content").on("change", "input.wsUICheckbox_112302", function(e) {
	...
	_wsProgress(80);
	$.getJSON('https://script.google.com/macros/s/AKfycbwd7cfIIFfE29oIaPv905p5WwTclpNjURJlucEiiULfz97Znxg/exec?type=doclock&sl='+dataItem.sl+'&values='+act+'&ID='+dataItem.ID).done(function(result){
		_wsProgress(100);
		if(result){
...
function wsUIButton_112301(e){
	...
	if(dataItem.Documents != ''){
		...
		_wsProgress(80);
		$.getJSON('https://script.google.com/macros/s/AKfycbwd7cfIIFfE29oIaPv905p5WwTclpNjURJlucEiiULfz97Znxg/exec?type=documents&sl='+dataItem.sl+'&values='+dataItem.ID).done(function(result){
			_wsProgress(100);
			if(result){
