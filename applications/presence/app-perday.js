$("#ws-explore").html('<div class="row"><div class="col-md-12"><h2>Presence</h2><p>Presence of people in office. It will reflect on attandance.</p></div></div><div class="row"><div class="col-md-12"><div class="col-md-12 bottom-20"><input id="ws-ui-113762" placeholder="Select Date" /><p>&nbsp;</p><div id="ws-ui-113762-1" class="bottom-20"></div></div></div></div>');
...
//if(window.authUser[0].Role == 'Power') userPayslipAccess = "";
	...
	$("#ws-ui-113762").kendoDatePicker({
		...
		change: function(e){
			...
			udate = this.value();
			udate = udate.getFullYear()+"-"+_ws_get_by_zero(udate.getMonth()+1)+"-"+_ws_get_by_zero(udate.getDate());
			...
			$("#ws-ui-113762-1").kendoGrid({
				dataSource: {
					...
					transport: {
						read: {
							url: "https://script.google.com/macros/s/AKfycbzcFm28XV2ikvDsBV0cmAp57MQt1y0hKnfXJAiUqugqWDx9exk/exec?type=grid&rl="+window.authUser[0].Role+"&date="+udate
						}
					},
