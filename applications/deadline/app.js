		...
		change: function(e){
			...
			$("#ws-ui-113762-2").kendoGrid({
				dataSource: {
					...
					transport: {
						read: {
							url: "https://script.google.com/macros/s/AKfycbzVkMNMk7TfEm5m_jj0mFD3P0s4Thx4Gbk27jVS9PwxGvzi02uW/exec?type=skill-report&rl="+window.authUser[0].Role+"&date="+udate+"&actimode=true&freeonly=true"
						}
					},
					schema:{
						model: {
