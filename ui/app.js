function checkAuth(){
	if(!_lget('authUser')){
		...
		_wsProgress(80);
		$.getJSON('https://script.google.com/macros/s/AKfycbzLvUex8tE3vYP3ptpgxL2xYFL3VeFTijgM7grWQQnw5lGI_Vi-/exec?type=navigation&rl='+window.authUser[0].Role).done(function(result){
			if(result){
