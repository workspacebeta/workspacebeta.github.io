...
function wsAuthUser(){
	...
	$.getJSON("https://script.google.com/macros/s/AKfycbwd7cfIIFfE29oIaPv905p5WwTclpNjURJlucEiiULfz97Znxg/exec?type=signin&rl=System&email="+$("#email").val()+"&password="+$("#password").val()).done(function(result){
		if(result){
